...
public:
	...
	******************************************************************************/
	...
	/******************************************************************************
	 函数名称： combinationSum4
	 功能说明： 组合总和4不存在重复数字-377背包问题
	 参    数： vector<int> & nums 
	 参    数： int target 
	 返 回 值： int
	 作    者： Ru Long
	...
	******************************************************************************/
	...
	/******************************************************************************
	 函数名称： characterReplacement
	 功能说明： 替换后的最长重复字符串长度-424滑动窗口
	 参    数： string s 
	 参    数： int k 
	 返 回 值： int
	 作    者： Ru Long
